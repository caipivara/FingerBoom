...
public class Top10Activity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if (counts < 10) {
			textInfo.setText("Look at yourself in a mirror... that's the worst player we've both seen");
